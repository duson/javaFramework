if (typeof jwplayer == "undefined") {
    ...
    (function(g) {
        ...
        q.isIETrident = function(t) {
            if (t) {
                ...
                return k(new RegExp("msie\\s*" + t + "|trident/.+rv:\\s*" + t, "i"))
            }
            ...
            if (v == g.events.JWPLAYER_FULLSCREEN && !x.fullscreen) {
                ...
                if (typeof x.data == f) {
                    ...
                    if (typeof x.metadata == f) {
                        q.deepReplaceKeyName(x.metadata, ["__dot__", "__spc__", "__dsh__", "__default__"], [".", " ", "-", "default"])
                    }
                }
            }
        ...
        q.flashVersion = function() {
            ...
            try {
                if (t !== s) {
                    u = t["Shockwave Flash"];
                    if (u) {
                        return parseInt(u.description.replace(/\D+(\d+)\..*/, "$1"), 10)
                    }
                }
            } catch (w) {}
            if (typeof r.ActiveXObject != s) {
                try {
                    ...
                    if (u) {
                        return parseInt(u.GetVariable("$version").split(" ")[1].split(",")[0], 10)
                    }
                } catch (v) {}
            }
            return 0
        ...
        q.youTubeID = function(u) {
            try {
                return (/v[=\/]([^?&]*)|youtu\.be\/([^?]*)|^([\w-]*)$/i).exec(u).slice(1).join("").replace("?", "")
            } catch (t) {
                return ""
            }
        };
        ...
        function n(t) {
            return (t && t.indexOf("://") >= 0) && (t.split("/")[2] != r.location.href.split("/")[2])
        }
            ...
            return function() {
                ...
                if (w) {
                    ...
                    try {
                        ...
                        if (y) {
                            B = y.firstChild;
                            if (y.lastChild && y.lastChild.nodeName === "parsererror") {
                                if (t) {
                                    t("Invalid XML")
                                }
                                return
        ...
        q.parseXML = function(t) {
            ...
            try {
                if (r.DOMParser) {
                    ...
                    if (u.childNodes && u.childNodes.length && u.childNodes[0].firstChild.nodeName == "parsererror") {
                        return
                    }
                } else {
        ...
        b.plugins.pluginloader = function(j, i) {
            ...
            function o() {
                ...
                if (!e && !l) {
                    var r = 0,
                        q = j.getPlugins();
                    a.foreach(n, function(t, x) {
                        var u = a.getPluginName(t),
                            y = q[u],
                            w = y.getJS(),
                            v = y.getTarget(),
                            s = y.getStatus();
                        if (s == a.loaderstatus.LOADING || s == a.loaderstatus.NEW) {
                            ...
                            if (w && (!v || parseFloat(v) > parseFloat(b.version))) {
                                l = true;
            ...
            this.setupPlugins = function(t, r, v) {
                var s = {
                    ...
                    q = j.getPlugins();
                d(r.plugins, function(z, B) {
                    var A = a.getPluginName(z),
                        C = q[A],
                        D = C.getFlashPath(),
                        E = C.getJS(),
                        w = C.getURL();
                    ...
                    try {
                        if (E && r.plugins && r.plugins[w]) {
                            ...
                            u.plugins[A] = C.getNewInstance(t, a.extend({}, r.plugins[w]), x);
                            u.length++;
    ...
    (function(c) {
        ...
        var h = c.embed = function(s) {
            var m = new h.config(s.config),
                ...
                C = c.plugins.loadPlugins(s.id, m.plugins),
                q = f,
                y = f,
                t = null,
                v = this;
            ...
            function p() {
                ...
                if (b.typeOf(m.playlist) == "array" && m.playlist.length < 2) {
                    if (m.playlist.length == 0 || !m.playlist[0].sources || m.playlist[0].sources.length == 0) {
                        r();
                        return
                    }
                }
                ...
                if (C.getStatus() == b.loaderstatus.COMPLETE) {
                    for (var H = 0; H < m.modes.length; H++) {
                        if (m.modes[H].type && h[m.modes[H].type]) {
                            var D = b.extend({}, m),
                                F = new h[m.modes[H].type](n, m.modes[H], D, C, s);
                            if (F.supportsConfig()) {
            ...
            function w() {
                ...
                if (B && B.length) {
                    ...
                    for (F = 0; F < A.length; F++) {
                        var z = A[F],
                            H = z.type ? z.type : i.extensionmap.extType(i.extension(z.file));
                        if (z.file) {
    ...
    (function(c) {
        ...
        var f = c.embed.flash = function(l, m, p, k, n) {
            ...
            this.embed = function() {
                    ...
                    if (n.config.aspectratio) {
                        ...
                        if (u) {
                            if (u.position == "bottom") {
                                ...
                                if (u.position == "right") {
                                    C.style.marginBottom = (-1 * u.size * (v / 100)) + "px"
                                }
                            }
                        }
                    }
                ...
                var F = "#000000",
                    A, t = x.wmode ? x.wmode : (x.height && x.height <= 40 ? "transparent" : "opaque"),
                ...
                a[l.id] = x;
                if (b.isIE()) {
                    var B = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" " width="100%" height="100%"id="' + l.id + '" name="' + l.id + '" tabindex=0"">';
    ...
    (function(d, h) {
        ...
        var f = d.api = function(s) {
            ...
            v.getPlaylist = function() {
                ...
                if (v.renderingMode == "flash") {
                    a.deepReplaceKeyName(B, ["__dot__", "__spc__", "__dsh__", "__default__"], [".", " ", "-", "default"])
                }
                return B
            };
            ...
            v.resize = function(D, B) {
                if (v.renderingMode !== "flash") {
                    ...
                    var E = g.getElementById(v.id + "_wrapper"),
                        C = g.getElementById(v.id + "_aspect");
                    if (C) {
                        C.style.display = "none"
                    }
                    if (E) {
            ...
            function k(B, C) {
                try {
                    B.jwAddEventListener(C, 'function(dat) { jwplayer("' + v.id + '").dispatchEvent("' + C + '", dat); }')
                } catch (D) {
                        ...
                        if (typeof D === "function") {
                            try {
                                if (F === e.JWPLAYER_PLAYLIST_LOADED) {
                                    a.deepReplaceKeyName(C.playlist, ["__dot__", "__spc__", "__dsh__", "__default__"], [".", " ", "-", "default"])
                                }
                                D.call(this, C)
                            } catch (G) {
        ...
        f.destroyPlayer = function(k) {
            ...
            if (j >= 0) {
                var o = l.id,
                    i = g.getElementById(o + (l.renderingMode == "flash" ? "_wrapper" : ""));
                if (a.clearCss) {
                    a.clearCss("#" + o)
                }
                if (i) {

package duson.java.solutionConf.shiroCas.session;
...
import duson.java.solutionConf.cache.jedis.JedisUtils;
import duson.java.utils.date.DateUtils;
...
public class JedisSessionDAO extends AbstractSessionDAO implements SessionDAO {
	...
	public void update(Session session) throws UnknownSessionException {
		...
		// TODO:如果是静态文件，则不更新SESSION,return;
	...
	protected Serializable doCreate(Session session) {
		// TODO:如果是静态文件，则不创建SESSION,return null;
	...
	protected Session doReadSession(Serializable sessionId) {
		...
		Session s = null;
		// TODO:如果是静态文件，则不获取SESSION,return null;

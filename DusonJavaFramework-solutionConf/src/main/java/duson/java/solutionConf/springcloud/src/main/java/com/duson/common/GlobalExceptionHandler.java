...
@ControllerAdvice(basePackages={"com.facewnd.ad.front", "com.facewnd.ad.backend"})
public class GlobalExceptionHandler {
	...
	public RestResult<String> jsonErrorHandler(HttpServletRequest req, Exception e) throws Exception {
		logger.error("系统异常", e);
		return new RestResult<String>(false, null).setErrorCode(ErrorCode.Error.toString()).setErrorMsg("前后台服务不可用，请稍候访问");
	}

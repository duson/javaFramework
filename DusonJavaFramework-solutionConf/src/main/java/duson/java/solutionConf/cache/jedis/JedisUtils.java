...
import duson.java.core.reflect.ObjectUtils;
import duson.java.solutionConf.springmvc.SpringContextHolder;
...
public class JedisUtils {
	...
	public static final String KEY_PREFIX = "redis.keyPrefix"; // 从配置文件获取

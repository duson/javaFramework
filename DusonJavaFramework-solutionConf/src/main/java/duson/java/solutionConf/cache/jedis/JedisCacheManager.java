...
//			logger.debug("Init: cacheKeyName {} ", cacheKeyName);
		...
		public V get(K key) throws CacheException {
			...
			try {
				...
				logger.debug(String.format("get {} {}", cacheKeyName, key));
			} catch (Exception e) {
				logger.error(String.format("get {} {}", cacheKeyName, key), e);
			} finally {
		...
		public V put(K key, V value) throws CacheException {
			...
			try {
				...
				logger.debug(String.format("put {} {} = {}", cacheKeyName, key, value));
			} catch (Exception e) {
				logger.error(String.format("put {} {}", cacheKeyName, key), e);
			} finally {
				JedisUtils.returnResource(jedis);
			}
			return value;
		...
		public V remove(K key) throws CacheException {
			...
			try {
				...
				logger.warn(String.format("remove {} {}", cacheKeyName, key), e);
			} finally {
				JedisUtils.returnResource(jedis);
			}
			return value;
